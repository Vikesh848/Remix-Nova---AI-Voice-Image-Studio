...
const AssistantView: React.FC<AssistantViewProps> = ({ 
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Note: Maps and Search grounding logic
            ...
            >
               ...
               <div className="space-y-4">
                  ...
                  <div className="flex gap-4 justify-center pt-8">
                     <div className="text-[9px] font-black uppercase text-accent/60 tracking-[0.2em] px-4 py-2 glass rounded-full mono">⌘ , SETTINGS</div>
                     <div className="text-[9px] font-black uppercase text-accent/60 tracking-[0.2em] px-4 py-2 glass rounded-full mono">⌘ L LIVE</div>
                  </div>
               </div>
            </motion.div>
          )}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          {[
                            ...
                            >
                              ...
                              <p className="text-slate-500 text-[9px] uppercase tracking-widest mono">{v.desc} • {v.accent}</p>
                            </motion.div>
                          ))}
